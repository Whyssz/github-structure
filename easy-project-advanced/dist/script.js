...
/* harmony import */ var _modules_pirctureSize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pirctureSize */ "./src/js/modules/pirctureSize.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pirctureSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(selectorBtn, selectorMenu) {
  var btnBurger = document.querySelector(selectorBtn),
...
/***/ "./src/js/modules/checkTstInputs.js":
/*!******************************************!*\
  !*** ./src/js/modules/checkTstInputs.js ***!
  \******************************************/
/*! exports provided: default */
...
var filter = function filter() {
  ...
  var markDetection = function markDetection(trigger, activeMark) {
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    elem.focus(); // Use in old browsers (EX--)
...
var modals = function modals() {
    ...
    setTimeout(function () {
      ...
      document.querySelectorAll('[data-modal]').forEach(function (item) {
        ...
        if (!display) {
          ...
          document.body.style.overflow = 'hidden';
          document.querySelector('.fixed-gift').style.marginRight = "".concat(scroll, "px");
  ...
  openByScroll('.fixed-gift'); // opeModalByTime('.popup-design', 60000); 
};
...
/***/ "./src/js/modules/pirctureSize.js":
/*!****************************************!*\
  !*** ./src/js/modules/pirctureSize.js ***!
  \****************************************/
/*! exports provided: default */
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could no fetch ".concat(url, ", status: ").concat(res.status));
