...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('form', 'assets/questions.php').init();
});
...
function () {
  ...
  _createClass(Difference, [{
    key: "bingdTriggers",
    value: function bingdTriggers(item, list, count) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          formData(_this.path, formData).then(function (res) {
            console.log(res);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return uplayVideo; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function uplayVideo(triggers, popup) {
    _classCallCheck(this, uplayVideo);
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.showSlide(_this2.showSlide);
        });
      });
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animate, autoPlay) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, animate, autoPlay));
    _this.sortList;
    _this.timer;
    return _this;
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      var notSortList = Array.from(this.slides);
      this.sortList = notSortList.filter(function (item) {
        return item.tagName != 'BUTTON';
      });
      this.sortList.forEach(function (slide) {
    ...
    value: function bindSLides() {
      ...
      this.prev.addEventListener('click', function () {
        var active = _this3.sortList[_this3.sortList.length - 1];

        _this3.container.insertBefore(active, _this3.sortList[0]);
  ...
  return MiniSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_11__["default"]);
