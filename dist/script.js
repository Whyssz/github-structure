...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modaleState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'slick-current');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modaleState);
...
const changeModalState = state => {
  ...
  bindActionToElem(windowType, 'input', 'type');
  bindActionToElem(windowCheckbox, 'input', 'checkbox');
};
...
const modals = () => {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(item => {
      ...
      item.addEventListener('keydown', e => {
        if (e.code === 'Escape' && modal.style.display === 'block' && closeClickOverlay) {
          window.forEach(item => {
            item.style.display = 'none';
          });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // opeModalByTime('.popup', 60000);
};
