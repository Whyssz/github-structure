/*
  ...
  final state machine (FSM / SM)   

  HOC - Любой HOC - это функция, которая возвращает другую функцию, но уже с дополнительными возможностями. Компоненты работают по тому же принципу.
